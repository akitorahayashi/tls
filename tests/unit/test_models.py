...
class TestEvaluationBlock:
    ...
    def test_create_minimal_block(self) -> None:
    ...
    def test_block_with_grading(self) -> None:
    ...
    def test_test_case_optional_fields(self) -> None:
